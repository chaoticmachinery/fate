...
def parseevtx(infile,outdir,coldelimiter,jsonfile):  
    ...
    for record in parser.records_json():
        ...
        lineout = ""
        try:
           eventid = subrec['Event']['System']['EventID']['#text']          #['#text']
        except:
        ...
        if eventid == 400 or eventid == 403 or eventid == 600:
           if channel == "Windows PowerShell":
              try:
                 #printjson(subrec) 
                 address = ''
                 lineout = fielddelimiter + str(eventid) + fielddelimiter+coldelimiter      #1
                 lineout = lineout + fielddelimiter + computer + fielddelimiter+coldelimiter  #2
                 lineout = lineout + fielddelimiter + systemtime + fielddelimiter+coldelimiter #3
                 ...
                 lineout = lineout + fielddelimiter + tmpstr + fielddelimiter+coldelimiter   #7
                 lineout = lineout + ""+coldelimiter #8
                 lineout = lineout + fielddelimiter + eventidtxt[str(eventid)] + fielddelimiter+coldelimiter #9
                 lineout = lineout + fielddelimiter + channel + fielddelimiter+coldelimiter  #10
                 lineout = lineout + fielddelimiter + infile + fielddelimiter  #11
                 lineout = lineout + "\n"
                 #print(f'{lineout}')
        ...
        if eventid == 6:
           if channel == "Microsoft-Windows-WinRM/Operational":
              try:
                 ...
                 lineout = lineout + fielddelimiter + computer + fielddelimiter+coldelimiter  #2
                 lineout = lineout + fielddelimiter + systemtime + fielddelimiter+coldelimiter #3
                 lineout = lineout + fielddelimiter + subrec['Event']['System']['Security']['#attributes']['UserID'] + fielddelimiter+coldelimiter  #4
                 lineout = lineout + ""+coldelimiter  #5
                 lineout = lineout + ""+coldelimiter  #6
                 lineout = lineout + "'Connecting remotely to: " + subrec['Event']['EventData']['connection'] + fielddelimiter+coldelimiter   #7
                 try:
                    lineout = lineout + fielddelimiter + subrec['Event']['System']['Correlation']['#attributes']['ActivityID'] + fielddelimiter+coldelimiter  #8
                 except: 
        ...
        if eventid == 81:
           if channel == "Microsoft-Windows-WinRM/Operational":
              try:
                 ...
                 lineout = lineout + ""+coldelimiter  #5
                 lineout = lineout + ""+coldelimiter  #6
                 lineout = lineout + "'Operation Name: " + subrec['Event']['EventData']['operationName'] + fielddelimiter+coldelimiter   #7
                 try:
                    lineout = lineout + fielddelimiter + subrec['Event']['System']['Correlation']['#attributes']['ActivityID'] + fielddelimiter+coldelimiter  #8
                 except: 
                    lineout = lineout + "''"+coldelimiter 
        ...
        if eventid == 82:
           if channel == "Microsoft-Windows-WinRM/Operational":
              try:
                 ...
                 lineout = lineout + ""+coldelimiter  #5
                 lineout = lineout + ""+coldelimiter  #6
                 lineout = lineout + "'Operation: " + subrec['Event']['EventData']['operation'] + " -- Resource URI: " + subrec['Event']['EventData']['resourceURI'] + fielddelimiter + coldelimiter   #7
                 try:
                    lineout = lineout + fielddelimiter + subrec['Event']['System']['Correlation']['#attributes']['ActivityID'] + fielddelimiter+coldelimiter  #8
                 except: 
                    lineout = lineout + "''"+coldelimiter 
        ...
        if eventid == 134:
           if channel == "Microsoft-Windows-WinRM/Operational":
              try:
                 ...
                 lineout = lineout + ""+coldelimiter  #5
                 lineout = lineout + ""+coldelimiter  #6
                 lineout = lineout + "'Operation: " + subrec['Event']['EventData']['operationName'] + fielddelimiter + coldelimiter   #7
                 try:
                    lineout = lineout + fielddelimiter + subrec['Event']['System']['Correlation']['#attributes']['ActivityID'] + fielddelimiter+coldelimiter  #8
                 except: 
                    lineout = lineout + "''"+coldelimiter 
        ...
        if eventid == 169:
           if channel == "Microsoft-Windows-WinRM/Operational":
              try:
                 ...
                 lineout = lineout + fielddelimiter + systemtime + fielddelimiter+coldelimiter #3
                 lineout = lineout + fielddelimiter + subrec['Event']['System']['Security']['#attributes']['UserID'] + fielddelimiter+coldelimiter  #4
                 lineout = lineout + fielddelimiter + subrec['Event']['EventData']['username'] + fielddelimiter+coldelimiter  
                 lineout = lineout + ""+coldelimiter  #6
                 lineout = lineout + "'Authentication Mechanism: " + subrec['Event']['EventData']['authenticationMechanism'] + fielddelimiter+coldelimiter   #7
                 try:
                    lineout = lineout + fielddelimiter + subrec['Event']['System']['Correlation']['#attributes']['ActivityID'] + fielddelimiter+coldelimiter  #8
                 except: 
                    lineout = lineout + "''"+coldelimiter 
        ...
        if eventid == 4100:
           if channel == "Microsoft-Windows-PowerShell/Operational":
              try:
                 ...
                 lineout = lineout + fielddelimiter + tmpstr + fielddelimiter+coldelimiter  #7
                 lineout = lineout + fielddelimiter + subrec['Event']['EventData']['Payload'] + fielddelimiter+coldelimiter   #8
                 lineout = lineout + fielddelimiter + eventidtxt[str(eventid)] + fielddelimiter+coldelimiter   #9
                 lineout = lineout + fielddelimiter + channel + fielddelimiter+coldelimiter   #10
                 lineout = lineout + fielddelimiter + infile + fielddelimiter   #11
                 lineout = lineout + "\n"
        ...
        if eventid == 4103:
           if channel == "Microsoft-Windows-PowerShell/Operational":
              try:
                 ...
                 tmpstr = tmpstr.join(subrec['Event']['EventData']['ContextInfo'])
                 lineout = lineout + fielddelimiter + tmpstr + fielddelimiter+coldelimiter  #7
                 lineout = lineout + fielddelimiter + subrec['Event']['EventData']['Path'] + fielddelimiter+coldelimiter   #8
                 lineout = lineout + fielddelimiter + eventidtxt[str(eventid)] + fielddelimiter+coldelimiter  #9
                 lineout = lineout + fielddelimiter + channel + fielddelimiter+coldelimiter  #10
                 lineout = lineout + fielddelimiter + infile + fielddelimiter   #11
                 lineout = lineout + "\n"
           ...
           if channel == "Security":
              try:
                 if re.search('powershell',subrec['Event']['EventData']['NewProcessName'],re.IGNORECASE):
                    ...
                    lineout = lineout + fielddelimiter + computer + fielddelimiter+coldelimiter  #2
                    lineout = lineout + fielddelimiter + systemtime + fielddelimiter+coldelimiter #3
                    lineout = lineout + fielddelimiter + subrec['Event']['EventData']['SubjectDomainName'] + "\\" + subrec['Event']['EventData']['SubjectUserName'] + " ("+ subrec['Event']['EventData']['SubjectUserSid'] +")'"+coldelimiter  #4
                    lineout = lineout + ""+coldelimiter  #5
                    lineout = lineout + ""+coldelimiter #6
                    try:
                       ...
                       try:
                          ...
                          tmpppn = ''
                       if tmpstr: 
                             lineout = lineout + fielddelimiter + tmpppn + " -> " + subrec['Event']['EventData']['CommandLine'] + fielddelimiter+coldelimiter  #7
                       else:
                          lineout = lineout + fielddelimiter + tmpppn + " -> " + subrec['Event']['EventData']['NewProcessName'] + fielddelimiter+coldelimiter  #7
                    except:
                       lineout = lineout + fielddelimiter + tmpppn + " -> " + subrec['Event']['EventData']['NewProcessName'] + fielddelimiter+coldelimiter  #7
                    lineout = lineout + ""+coldelimiter #8
                    lineout = lineout + fielddelimiter + eventidtxt[str(eventid)] + fielddelimiter+coldelimiter  #9
...
def main(argv):
   ...
   coldelimiter = '|'
   try:
      opts, args = getopt.getopt(argv,"hi:o:d:f:j",["infile=","outdir=","deliminator=","field="])
   except getopt.GetoptError:
      print ('pwrshell_evtx_parser.py -i <inputfile> -o <outputdir> -d <CSV Deliminator; | = default> -f <field deliminater; ~ = default> -j')
      sys.exit(2)
   for opt, arg in opts:
      if opt == '-h':
